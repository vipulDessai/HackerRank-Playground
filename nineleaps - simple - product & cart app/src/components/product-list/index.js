                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    ...
                                    {
                                        product.cartQuantity === 0 && <button className="x-small outlined" onClick={() => this.props.addToCart(product.id)} data-testid="btn-item-add">
                                            Add To Cart
                                        </button>
                                    }

                                    {
                                        product.cartQuantity > 0 && <div className="layout-row justify-content-between align-items-center">
                                            <button onClick={() => this.props.decQuantity(product.id)} className="x-small icon-only outlined"
                                            ...
                                            <button onClick={() => this.props.incQuantity(product.id)} className="x-small icon-only outlined"
